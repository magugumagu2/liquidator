...
import {IUsdxlFacilitator} from "./IUsdxlFacilitator.sol";
import {IUsdxlToken} from "./IUsdxlToken.sol";
...
interface IUsdxlFlashMinter is IERC3156FlashLender, IUsdxlFacilitator {
     ...
     */
    event FlashMint(
        address indexed receiver, address indexed initiator, address asset, uint256 indexed amount, uint256 fee
    );
